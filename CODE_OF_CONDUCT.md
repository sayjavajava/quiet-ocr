...
reported using [the same private-reporting path described in `SECURITY.md`](SECURITY.md)
(GitHub's private reporting for this repository), so a report doesn't have to be
made in public. All complaints will be reviewed and investigated promptly and
fairly.
